...
<div class="page">
    <!--========================================================
                              HEADER
    =========================================================-->
    <header class="header--mod skew__deg-1_before-inset">
  ...
  =========================================================-->
  <main>
     <section id="content" class="content skew skew__deg-1 skew__deg-1_before-inset">
              ...
              <div class="container skew_cnt well text-center">
                 <form class="search-form search-form--mod" action="search.php" method="GET" accept-charset="utf-8">
